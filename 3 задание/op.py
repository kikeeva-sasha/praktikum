def rowsnumber(table_name: str, start: int, stop: int, copy_table=False):
...
#rowsnumber('test.csv', 1,2,1)


def rowsindex(table_name: str, *args: str|int, copy_table=False):
    with open(table_name, 'r', encoding='utf-8') as f:
        column = []
        table = f.readlines()
...
#rowsindex('test_txt.txt', 'Василиса','Иван','23',copy_table=True)


def types(table_name: str, by_number=True):
    with open(table_name, 'r', encoding='utf-8') as f:
        values = {}
        column = []
        table = f.readlines()
        ...
        for i in range(len(table[0].split(','))):
            ...
            column = []
        return values
#print(types('test_txt', False))


def set_types(table_name: str, by_number=True, *types_dict:str):
    with open(table_name, 'r', encoding='utf-8') as f:
        values = {}
        column = []
        table = f.readlines()
...
#print(set_types('test_txt', True, 'str', 'boolean','int'))
